...
1. **Static 2D Avatar** – A still image of a character. 🖼️
2. **Animated 2D Avatar** – A moving character based on an image. 🎞️
3. **3D Avatar** – A realistic 3D model that can talk and move. 🕴️
